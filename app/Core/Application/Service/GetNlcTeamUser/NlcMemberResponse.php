...
class NlcMemberResponse implements JsonSerializable
{
     ...
     * @param string $alamat
     * @param ?string $bingo_file_url
     */
    public function __construct(string $member_id, string $status, string $name, string $member_type, string $nisn, string $surat_url, ?string $bukti_twibbon_url, ?string $bukti_poster_url, ?string $bukti_vaksin_url, string $no_telp, string $no_wa, string $id_line, string $alamat, ?string $bingo_file_url)
    {
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            "alamat" => $this->alamat,
            "bingo_file_url" => $this->bingo_file_url
        ];
    }
}
